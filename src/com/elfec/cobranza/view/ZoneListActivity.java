 ...
 * {@link ZoneDetailActivity} representing item details. On tablets, the
...
public class ZoneListActivity extends Activity implements
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			arguments.putString(ZoneDetailFragment.ARG_ITEM_ID, id);
			...
			Intent detailIntent = new Intent(this, ZoneDetailActivity.class);
			detailIntent.putExtra(ZoneDetailFragment.ARG_ITEM_ID, id);
