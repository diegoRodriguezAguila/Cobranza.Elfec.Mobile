package com.elfec.cobranza.view.controls;
...
public class SlidingTabLayout extends HorizontalScrollView {
	 ...
	 * @param textViewId
	 *            id of the TextView in the inflated view
	 */
	 ...
	 *            id of the TextView in the inflated view
	 * @param iconId
	 *            id of the ImageView int the inflated view
	 */
	...
	private void populateTabStrip() {
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			...
			if (tabIcon != null && (adapter instanceof IconTabProvider))
				tabIcon.setImageDrawable(ContextCompat.getDrawable(
						getContext(),
						((IconTabProvider) adapter).getPageIconResId(i)));
