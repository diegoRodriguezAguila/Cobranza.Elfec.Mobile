...
public class AnnulmentReasonAdapter implements SpinnerAdapter, ListAdapter {
	 ...
	 * @param context
	 */
	public AnnulmentReasonAdapter(SpinnerAdapter spinnerAdapter,
			Context context, int nothingSelectedLayout) {
	...
	/**
	 * Agrega un mensaje de error al
	 * 
	 * @param error
	 */
	public void setError(View selectedView, CharSequence error) {
		if (selectedView instanceof TextView) {
			TextView txtView = ((TextView) selectedView);
			txtView.setError(error);
			if (error != null)
				txtView.setTextColor(ContextCompat.getColor(context,
